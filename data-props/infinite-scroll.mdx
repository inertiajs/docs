...
```html Vue icon="vuejs"
<InfiniteScroll data="users" :buffer="500"> \<!-- ... --> </InfiniteScroll>
```
...
```html Vue icon="vuejs"
<InfiniteScroll data="users" preserve-url> \<!-- ... --> </InfiniteScroll>
```
...
<InfiniteScroll data="users" trigger="end"> \<!-- ... --> </InfiniteScroll>

\<!-- Only load when scrolling up -->
<InfiniteScroll data="messages" trigger="start"> \<!-- ... --> </InfiniteScroll>

\<!-- Load in both directions (default) -->
<InfiniteScroll data="posts" trigger="both"> \<!-- ... --> </InfiniteScroll>
```
...
```html Vue icon="vuejs"
<InfiniteScroll data="messages" reverse> \<!-- ... --> </InfiniteScroll>
```
...
```html Vue icon="vuejs"
<InfiniteScroll data="users" :manual-after="3"> \<!-- ... --> </InfiniteScroll>
```
