...
<a href="/users" use:inertia={{ prefetch: true }}>
  Users
</a>;
```
...
<a href="/users" use:inertia={{ prefetch: "click" }}>
  Users
</a>;
```
...
<a href="/users" use:inertia={{ prefetch: "mount" }}>
  Users
</a>;
```
...
<a href="/users" prefetch={["mount", "hover"]}>
  Users
</a>;
```
...
<a href="/users" use:inertia={{ prefetch: ["mount", "hover"] }}>
  Users
</a>;
```
...
<template>
  ...
  <a href="/dashboard" prefetch :cache-tags="['dashboard', 'stats']"
    >Dashboard</a
  >
</template>
```
...
<a href="/users" prefetch cacheFor={["30s", "1m"]}>
  Users
</a>;
```
