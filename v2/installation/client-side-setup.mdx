...
The `laravel-vite-plugin` package also provides a [`resolvePageComponent`](https://laravel.com/docs/vite#inertia) helper that automatically handles component resolution and lazy-loading for you.
