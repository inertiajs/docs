...
To share translation strings and language files across your application without manual payload management, see the [Localization documentation](/v2/the-basics/localization).
