...
You may configure the flash data type globally using TypeScript's declaration merging. This provides type safety when accessing flash data throughout your application.
