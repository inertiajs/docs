...
To share translation strings and language files across your application without manual payload management, see the [Localization documentation](/v1/the-basics/localization).
